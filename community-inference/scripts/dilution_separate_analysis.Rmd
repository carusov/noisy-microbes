...
alpha_indices <- c("Shannon", "Simpson", "InvSimpson", "Fisher")
alpha_div <- lapply(physeqs, estimate_richness, measures = c("Shannon", "Simpson", "InvSimpson", "Fisher"))
...
alpha_dots <- ggplot(alpha_div_gg %>% filter(alpha_index %in% c("Simpson")), aes(x = sample, group = method)) +
  geom_point(aes(y = diversity, color = alpha_index))
alpha_dots

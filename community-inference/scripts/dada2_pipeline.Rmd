...
# data_path <- "~/repo_test/data/high_biomass/zymo"
# dada2_path <- "~/repo_test/results/high_biomass/zymo/dada2"     # directory where DADA2 processing results will be stored

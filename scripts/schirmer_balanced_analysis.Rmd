...
result_path <- "~/projects/thesis/results/schirmer_balanced"
ref_path <- "~/projects/thesis/references"
analysis_path <- "~/projects/thesis/analysis/schirmer_balanced"
...
countNoisySeqs <- function(seq_table, dist_mat, min_dist = 1, max_dist = 3) {
  ...
  for (n in min_dist:max_dist){
    ...
    has_zero <- apply(dist_mat[, noisy_ind[, "col"]], 2, min) == 0  # is there a hit to the nearest reference?
    noisy_ind <- noisy_ind[has_zero, ]

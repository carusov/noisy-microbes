...
non_reflike_seq_lines <- dilution_line_plot(all_table_gg, "class", !ref_like, "count") +
  scale_color_manual(name = "Sequence class   ", values = class_colors[3:5], labels = paste(classes[3:5], "   ")) +
  # scale_color_brewer(name = "Seqeunce class   ", palette = "Dark2", labels = paste(classes[3:5], "   ")) +
  facet_wrap(~method) +
  big_labels()
...
reflike_seq_lines <- dilution_line_plot(all_table_gg, "class", ref_like, "count") +
  scale_color_manual(name = "Sequence class   ", values = class_colors[5:4], labels = paste(classes[1:2], "   ")) +
  # scale_color_brewer(name = "Seqeunce class   ", palette = "Dark2", labels = paste(classes[1:2], "   ")) +
  facet_wrap(~method) +
  big_labels()
reflike_seq_lines

ggarrange(reflike_seq_lines, non_reflike_seq_lines, labels = c("A", "B"), nrow = 2)
